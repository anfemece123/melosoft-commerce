...
import type { CartaCategoryImagePosition, CartaCategoryImageSize } from '@/features/carta/carta.types';
...
export function CartaCategoryImagePicker({ categories, products, selections, positions, sizes, onChange, onPositionsChange, onSizesChange }: CartaCategoryImagePickerProps) {
  return (
          ...
          <div key={category.id} className="border-b border-gray-100 p-3.5 last:border-b-0">
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                ...
                <p className="mt-0.5 truncate text-[11px] text-gray-500">{selectedLabel ? `Elegida: ${selectedLabel}` : 'No hay fotografías disponibles'}</p>
              </div>
              <span className="shrink-0 text-[10px] font-semibold uppercase tracking-wide text-indigo-600">Una imagen</span>
            </div>
            ...
            {options.length === 0 ? (
              ...
              <>
                ...
                <div className="mt-3">
                  <p className="mb-2 text-[10px] font-semibold uppercase tracking-wide text-gray-400">Ubicación</p>
