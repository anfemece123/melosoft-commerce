    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
      ...
      <div role="dialog" aria-modal="true" aria-labelledby={titleId} className="relative flex max-h-[90vh] w-full max-w-xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl">
        ...
        <div className="overflow-y-auto px-5 py-5">
          ...
          {retained.length === 0 && <p className="mt-2 text-xs text-red-600">El pedido debe conservar al menos un producto. Para eliminarlo completo, cancela el pedido.</p>}

          <label className="mt-4 block space-y-1.5">
            <span className="text-xs font-medium text-gray-600">Motivo del cambio *</span>
            <input value={reason} maxLength={500} placeholder="Ej. El cliente solicitó reducir la cantidad" onChange={e => setReason(e.target.value)} className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100" />
