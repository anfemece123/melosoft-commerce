...
export function mapStoreWhatsappConnectionRowToStoreWhatsappConnection(row: ConnectionRow): StoreWhatsappConnection {
  return {
    ...
    statusTemplateName: row.status_template_name,
    statusTemplateLanguage: row.status_template_language,
    statusTemplateStatus: row.status_template_status as WhatsappTemplateStatus,
    statusTemplateRejectedReason: row.status_template_rejected_reason,
    shipmentTemplateName: row.shipment_template_name,
    shipmentTemplateLanguage: row.shipment_template_language,
    shipmentTemplateStatus: row.shipment_template_status as WhatsappTemplateStatus,
    shipmentTemplateRejectedReason: row.shipment_template_rejected_reason,
