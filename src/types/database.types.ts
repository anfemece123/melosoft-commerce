    ...
    Tables: {
      ...
      store_carta_settings: {
        Row: {
          ...
          cover_layout: string;
          cover_product_ids: string[];
          cover_image_url: string | null;
          cover_background_image_url: string | null;
          show_logo: boolean;
      ...
      order_item_customizations: {
        Row: {
          ...
          price_delta: number;
          linked_product_id_snapshot: string | null;
          linked_variant_id_snapshot: string | null;
          linked_quantity_snapshot: number | null;
          created_at: string;
        };
        Insert: {
          id?: string;
    ...
    Views: {
      ...
      public_carta_pages: {
        Row: {
          ...
          title: string | null;
          subtitle: string | null;
          carta_template_key: string;
          carta_navigation_mode: string;
          show_category_descriptions: boolean;
          cover_layout: string;
          cover_product_ids: string[];
          cover_image_url: string | null;
...
export type StoreCartaSettingsRow = Database['public']['Tables']['store_carta_settings']['Row'];
export type StoreCartaSettingsRowInsert = Database['public']['Tables']['store_carta_settings']['Insert'];
export type StoreCartaSettingsRowUpdate = Database['public']['Tables']['store_carta_settings']['Update'];
...
export type PublicCartaPageRow = Database['public']['Views']['public_carta_pages']['Row'];
