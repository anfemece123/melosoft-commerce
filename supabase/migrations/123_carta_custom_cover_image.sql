-- ============================================================
-- Migration 123 — Uploaded cover image for Carta
-- ============================================================

ALTER TABLE public.store_carta_settings
  ADD COLUMN cover_image_url text;

COMMENT ON COLUMN public.store_carta_settings.cover_image_url IS
  'Optional owner-uploaded image used before selected product images in the Carta cover.';
