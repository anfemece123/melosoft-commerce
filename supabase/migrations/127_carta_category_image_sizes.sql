-- ============================================================
-- Migration 127 — Per-category image size for Carta
-- ============================================================

ALTER TABLE public.store_carta_settings
  ADD COLUMN category_image_sizes jsonb NOT NULL DEFAULT '{}'::jsonb;

COMMENT ON COLUMN public.store_carta_settings.category_image_sizes IS
  'Map of category UUID to responsive image size: small, medium, or large.';
