-- ============================================================
-- Migration 023 — Expose commerce settings in public views
-- Updates public_store_pages to include all commerce fields.
-- Updates public_product_pages to include checkout context.
-- Depends on: 019, 022
-- ============================================================
