-- ============================================================
-- Migration 129 — Per-category image modes for Carta
-- ============================================================

ALTER TABLE public.store_carta_settings
  ADD COLUMN category_image_modes jsonb NOT NULL DEFAULT '{}'::jsonb;

COMMENT ON COLUMN public.store_carta_settings.category_image_modes IS
  'Optional per-category overrides for product imagery: all, first_per_category, or none. Categories without an override inherit product_image_mode.';
