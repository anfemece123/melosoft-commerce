-- ============================================================
-- Migration 128 — Custom background image for Carta cover
-- ============================================================

ALTER TABLE public.store_carta_settings
  ADD COLUMN cover_background_image_url text;

COMMENT ON COLUMN public.store_carta_settings.cover_background_image_url IS
  'Optional uploaded background image displayed behind the Carta cover identity and content.';
