-- ============================================================
-- Migration 130 — Per-product image positions for Carta
-- ============================================================

ALTER TABLE public.store_carta_settings
  ADD COLUMN product_image_positions jsonb NOT NULL DEFAULT '{}'::jsonb;

COMMENT ON COLUMN public.store_carta_settings.product_image_positions IS
  'Optional Carta-only left/right image placement keyed by product id. Products without an override retain the template default.';
