-- ============================================================
-- Migration 125 — Owner-selected image for every Carta category
-- ============================================================

ALTER TABLE public.store_carta_settings
  ADD COLUMN category_image_selections jsonb NOT NULL DEFAULT '{}'::jsonb;

COMMENT ON COLUMN public.store_carta_settings.category_image_selections IS
  'Map of category UUID to category or product image selection used by the one-image-per-category Carta mode.';
