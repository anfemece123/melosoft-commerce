-- Keep temporarily unavailable items visible in the public menu. This is
-- the restaurant "sold out" pattern: customers can still understand the
-- menu, but the storefront disables ordering through is_available=false.
